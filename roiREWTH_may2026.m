...
%% Step 1: Manually re-orient the individual participant's structural scan
reorient_subSpace_structFile = [SUB_ROI 'manualOrient_' subSpace_structFilename];
if exist(reorientStructfile,'file')~=2
    copyfile(subSpace_structFile,reorient_subSpace_structFile);
    error('RUN MANUAL REORIENTATION ON STRUCTURAL FILE NOW!!!');
end
...
if exist(bNorm_rmPFC_roiFile,'file')~=2
    ...
    if run_rmPFCcreation
        ...
        [backNormROIfiles] = backNormROI_REWTH(reorient_subSpace_structFile,...
            reorient_subSpace_structFile,{mni_rmPFC_roiFile},'bNorm_',SUB_ROI);
...
if run_dlPFCcreation
    ...
    % epis go into reslice dir
    [backNormROIfiles] = backNormROI_REWTH(reorient_subSpace_structFile,...
        reorient_subSpace_structFile,{mni_dlPFC_roiFile},'bNorm_',SUB_ROI);
